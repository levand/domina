...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;c == 0 && g < f;g++) {
    var h = d[g] || "", i = e[g] || "", k = RegExp("(\\d*)(\\D*)", "g"), j = RegExp("(\\d*)(\\D*)", "g");
    do {
      var n = k.exec(h) || ["", "", ""], l = j.exec(i) || ["", "", ""];
      if(n[0].length == 0 && l[0].length == 0) {
        break
      }
      var c = n[1].length == 0 ? 0 : parseInt(n[1], 10), m = l[1].length == 0 ? 0 : parseInt(l[1], 10), c = goog.string.compareElements_(c, m) || goog.string.compareElements_(n[2].length == 0, l[2].length == 0) || goog.string.compareElements_(n[2], l[2])
    }while(c == 0)
  }
  return c
};
...
var cybozu = {xpath:{}};
(function() {
  var a = {targetFrame:void 0, exportInstaller:!1, useNative:!0, useInnerText:!0}, b;
  if(window.jsxpath) {
    b = window.jsxpath
  }else {
    var c = document.getElementsByTagName("script"), c = c[c.length - 1].src;
    b = {};
    if(c = c.match(/\?(.*)$/)) {
      for(var c = c[1].split("&"), d = 0, e = c.length;d < e;d++) {
        var f = c[d].split("="), g = f[0], f = f[1];
        if(f != void 0 && (f == "false" || /^-?\d+$/.test(f))) {
          f = eval(f)
        }
        b[g] = f
      }
  ...
  b.hasNative = !(!document.implementation || !document.implementation.hasFeature || !document.implementation.hasFeature("XPath", null));
  if(!b.hasNative || !b.useNative || b.exportInstaller) {
    var i, k, j, n, l, m, p, o, q, s, r, t, u, w, z = new function() {
      var a = navigator.userAgent;
      if(RegExp == void 0) {
        a.indexOf("Opera") >= 0 ? this.opera = !0 : a.indexOf("Netscape") >= 0 ? this.netscape = !0 : a.indexOf("Mozilla/") == 0 ? this.mozilla = !0 : this.unknown = !0;
        ...
        if(/AppleWebKit\/(\d+(?:\.\d+)*)/.test(a)) {
          this.applewebkit = RegExp.$1, RegExp.$1.charAt(0) == 4 ? this.applewebkit2 = !0 : this.applewebkit3 = !0
        }else {
          if(typeof Components == "object" && (/Gecko\/(\d{8})/.test(a) || navigator.product == "Gecko" && /^(\d{8})$/.test(navigator.productSub))) {
            this.gecko = RegExp.$1
          }
        }
        if(typeof opera == "object" && typeof opera.version == "function") {
          ...
          if(typeof opera == "object" && /Opera[\/ ](\d+\.\d+)/.test(a)) {
            this.opera = RegExp.$1
          }else {
            if(!this.ie) {
              if(/Safari\/(\d+(?:\.\d+)*)/.test(a)) {
                this.safari = RegExp.$1
              }else {
                if(/NetFront\/(\d+(?:\.\d+)*)/.test(a)) {
                  this.netfront = RegExp.$1
                }else {
                  if(/Konqueror\/(\d+(?:\.\d+)*)/.test(a)) {
                    this.konqueror = RegExp.$1
                  }else {
                    if(a.indexOf("(compatible;") < 0 && /^Mozilla\/(\d+\.\d+)/.test(a)) {
                      this.mozilla = RegExp.$1;
                      if(/\([^(]*rv:(\d+(?:\.\d+)*).*?\)/.test(a)) {
                        this.mozillarv = RegExp.$1
                      }
                      if(/Firefox\/(\d+(?:\.\d+)*)/.test(a)) {
                        this.firefox = RegExp.$1
                      }else {
                        if(/Netscape\d?\/(\d+(?:\.\d+)*)/.test(a)) {
        ...
        if(a.indexOf("Win 9x 4.90") >= 0) {
          this.windows = "ME"
        }else {
          if(/Win(?:dows)? ?(NT ?(\d+\.\d+)?|\d+|ME|Vista|XP)/.test(a)) {
            if(this.windows = RegExp.$1, RegExp.$2) {
              this.winnt = RegExp.$2
            }else {
              switch(RegExp.$1) {
                case "2000":
      ...
      for(var b = x.prototype, a = a.match(b.regs.token), c = 0, d = a.length;c < d;c++) {
        b.regs.strip.test(a[c]) && a.splice(c, 1)
      }
      for(var e in b) {
        a[e] = b[e]
      }
    ...
    x.prototype.regs = {token:/\$?(?:(?![0-9-])[\w-]+:)?(?![0-9-])[\w-]+|\/\/|\.\.|::|\d+(?:\.\d*)?|\.\d+|"[^"]*"|'[^']*'|[!<>]=|(?![0-9-])[\w-]+:\*|\s+|./g, strip:/^\s/};
    x.prototype.peek = function(a) {
      return this[this.index + (a || 0)]
    };
    ...
    a.prototype.number = function(a) {
      a = this.evaluate(a);
      return a.isNodeSet ? a.number() : +a
    };
    a.prototype.string = function(a) {
      a = this.evaluate(a);
      return a.isNodeSet ? a.string() : "" + a
    };
    a.prototype.bool = function(a) {
      a = this.evaluate(a);
      return a.isNodeSet ? a.bool() : !!a
    };
    var y = function() {
    };
    y.parsePredicates = function(a, b) {
      for(;a.peek() == "[";) {
        a.next();
        if(a.empty()) {
        ...
        if(a.next() != "]") {
          throw a.back(), Error("bad token: " + a.next());
        }
      }
    };
    y.prototype = new a;
    y.prototype.evaluatePredicates = function(a, b) {
      var c, d, e, f, g;
      g = this.reverse;
      c = this.predicates;
      a.sort();
      for(var h = b || 0, i = c.length;h < i;h++) {
        d = c[h];
        var l = [];
        e = a.list();
        for(var j = 0, k = e.length;j < k;j++) {
          f = g ? k - j : j + 1;
          exrs = d.evaluate(new v(e[j], f, k));
          switch(typeof exrs) {
            case "number":
              exrs = f == exrs;
              break;
    ...
    i = function(a, b, c) {
      ...
      this.left = b;
      this.right = c;
      this.datatype = i.ops[a][2];
      this.needContextPosition = b.needContextPosition || c.needContextPosition;
      this.needContextNode = b.needContextNode || c.needContextNode;
      if(this.op == "=") {
        if(!c.needContextNode && !c.needContextPosition && c.datatype != "nodeset" && c.datatype != "void" && b.quickAttr) {
          this.quickAttr = !0, this.attrName = b.attrName, this.attrValueExpr = c
        }else {
          if(!b.needContextNode && !b.needContextPosition && b.datatype != "nodeset" && b.datatype != "void" && c.quickAttr) {
            this.quickAttr = !0, this.attrName = c.attrName, this.attrValueExpr = b
          }
        }
      }
    };
    i.compare = function(a, b, c, d, e) {
      var f, g, c = c.evaluate(e), d = d.evaluate(e);
      if(c.isNodeSet && d.isNodeSet) {
        f = c.list();
        a = d.list();
        d = 0;
        for(c = f.length;d < c;d++) {
          ...
          for(g = a.length;e < g;e++) {
            if(b(o.to("string", f[d]), o.to("string", a[e]))) {
              return!0
            }
          }
        }
      ...
      return a == "=" || a == "!=" ? typeof c == "boolean" || typeof d == "boolean" ? b(!!c, !!d) : typeof c == "number" || typeof d == "number" ? b(+c, +d) : b(c, d) : b(+c, +d)
    };
    i.ops = {div:[6, function(a, b, c) {
      return a.number(c) / b.number(c)
    }, "number"], mod:[6, function(a, b, c) {
      return a.number(c) % b.number(c)
    }, "number"], "*":[6, function(a, b, c) {
      return a.number(c) * b.number(c)
    }, "number"], "+":[5, function(a, b, c) {
      return a.number(c) + b.number(c)
    }, "number"], "-":[5, function(a, b, c) {
      return a.number(c) - b.number(c)
    }, "number"], "<":[4, function(a, b, c) {
      return i.compare("<", function(a, b) {
        return a < b
      }, a, b, c)
    }, "boolean"], ">":[4, function(a, b, c) {
      return i.compare(">", function(a, b) {
        return a > b
      }, a, b, c)
    }, "boolean"], "<=":[4, function(a, b, c) {
    ...
    }, "boolean"], and:[2, function(a, b, c) {
      return a.bool(c) && b.bool(c)
    }, "boolean"], or:[1, function(a, b, c) {
      return a.bool(c) || b.bool(c)
    }, "boolean"]};
    i.parse = function(a) {
      for(var b, c, d, e = [];;) {
        ...
        for(;e.length && c <= this.ops[e[e.length - 1]][0];) {
          d = new i(e.pop(), e.pop(), d)
        }
        e.push(d, b)
      }
      for(;e.length;) {
    ...
    i.prototype.evaluate = function(a) {
      return i.ops[this.op][1](this.left, this.right, a)
    };
    ...
    t = function(a, b) {
      this.op = a;
      this.expr = b;
      this.needContextPosition = b.needContextPosition;
      this.needContextNode = b.needContextNode
    };
    t.ops = {"-":1};
    t.parse = function(a) {
      return this.ops[a.peek()] ? new t(a.next(), t.parse(a)) : u.parse(a)
    };
    t.prototype = new a;
    t.prototype.datatype = "number";
    t.prototype.evaluate = function(a) {
      return-this.expr.number(a)
    };
    ...
    u.prototype = new a;
    u.prototype.datatype = "nodeset";
    u.prototype.evaluate = function(a) {
      for(var b = this.paths, c = new m, d = 0, e = b.length;d < e;d++) {
        var f = b[d].evaluate(a);
        if(!f.isNodeSet) {
    ...
    u.prototype.path = function(a) {
      this.paths.push(a);
      if(a.needContextPosition) {
        this.needContextPosition = !0
      }
      if(a.needContextNode) {
        this.needContextNode = !0
      }
    };
    ...
    s = function(a) {
      ...
      this.needContextPosition = a.needContextPosition;
      this.needContextNode = a.needContextNode
    };
    s.ops = {"//":1, "/":1};
    s.parse = function(a) {
      var b, c, d;
      if(this.ops[a.peek()]) {
        b = a.next();
        c = a.peek();
        if(b == "/" && (a.empty() || c != "." && c != ".." && c != "@" && c != "*" && !/(?![0-9])[\w]/.test(c))) {
          return k.root()
        }
        d = new s(k.root());
        if(a.empty()) {
        ...
        if(c = k.parse(a)) {
          ...
          c = r.parse(a), d = new s(k.context()), d.step("/", c)
        }
      }
      for(;;) {
        if(!this.ops[a.peek()]) {
    ...
    s.prototype.evaluate = function(a) {
      var b = this.filter.evaluate(a);
      if(!b.isNodeSet) {
        throw Exception("Filter nodeset must be nodeset type");
      }
      for(var a = this.steps, c = 0, d = a.length;c < d && b.length;c++) {
        var e = a[c][1], f = b.iterator(e.reverse), g = b, h;
        if(!e.needContextPosition && e.axis == "following") {
          for(h = f();b = f();h = b) {
            if(z.applewebkit2) {
              var g = !1, i = b;
              do {
              ...
              try {
                ...
                if(!(b.compareDocumentPosition(h) & 8)) {
                  break
                }
              }
            }
          }
          b = e.evaluate(new v(h))
        }else {
          if(!e.needContextPosition && e.axis == "preceding") {
            h = f(), b = e.evaluate(new v(h))
          }else {
            h = f();
            i = 0;
            for(b = e.evaluate(new v(h), !1, g, i);h = f();) {
              i++, b.merge(e.evaluate(new v(h), !1, g, i))
            }
          }
        }
      }
    ...
    s.prototype.step = function(a, b) {
      b.op = a;
      this.steps.push([a, b]);
      this.quickAttr = !1;
      if(this.steps.length == 1 && a == "/" && b.axis == "attribute") {
        var c = b.test;
        if(!c.notOnlyElement && c.name != "*") {
          this.quickAttr = !0, this.attrName = c.name
        }
      }
    };
    s.prototype.show = function(a) {
      ...
      if(this.steps.length) {
        b += a + "steps:\n";
        a += "    ";
        for(var c = 0;c < this.steps.length;c++) {
          var d = this.steps[c];
          b += a + "operator: " + d[0] + "\n";
          b += d[1].show(a)
        }
    ...
    k.parse = function(a) {
      ...
      b = new k(b);
      y.parsePredicates(a, b);
      return b
    };
    k.root = function() {
      return new j("root-node")
    };
    k.context = function() {
      return new j("context-node")
    };
    k.prototype = new y;
    k.prototype.evaluate = function(a) {
      a = this.primary.evaluate(a);
      if(!a.isNodeSet) {
      ...
      return this.evaluatePredicates(a)
    };
    k.prototype.predicate = function(a) {
      this.predicates.push(a)
    };
    k.prototype.show = function(a) {
      var a = a || "", b = "";
      b += a + "filter: \n";
      a += "    ";
      b += this.primary.show(a);
      if(this.predicates.length) {
        b += a + "predicates: \n";
        a += "    ";
        for(var c = 0;c < this.predicates.length;c++) {
          b += this.predicates[c].show(a)
        }
      }
      return b
    };
    ...
    o = {to:function(a, c) {
      var e, f = c.nodeType;
      if(f == 1 && b.useInnerText && !z.applewebkit2) {
        e = c.textContent, e = e == void 0 || e == null ? c.innerText : e, e = e == void 0 || e == null ? "" : e
      }
      if(typeof e != "string") {
        if(f == 9 || f == 1) {
          c = f == 9 ? c.documentElement : c.firstChild;
          for(e = "", stack = [], d = 0;c;) {
            do {
              c.nodeType != 1 && (e += c.nodeValue), stack[d++] = c
            }while(c = c.firstChild);
            for(;d && !(c = stack[--d].nextSibling);) {
            }
          }
        }else {
          e = c.nodeValue
    ...
    }, attrPropMap:{name:"name", "class":"className", dir:"dir", id:"id", name:"name", title:"title"}, attrMatch:function(a, b, c) {
      return!b || c == null && a.hasAttribute && a.hasAttribute(b) || c != null && a.getAttribute && a.getAttribute(b) == c ? !0 : !1
    }, getDescendantNodes:function(a, b, c, d, e, f, g) {
      f && f.delDescendant(b, g);
      if(e && d == "id" && b.getElementById) {
        (b = b.getElementById(e)) && a.match(b) && c.push(b)
      }else {
        if(e && d == "name" && b.getElementsByName) {
          for(var f = b.getElementsByName(e), g = 0, h = f.length;g < h;g++) {
            b = f[g], (z.opera ? b.name == e && a.match(b) : a.match(b)) && c.push(b)
          }
        }else {
          if(e && d == "class" && b.getElementsByClassName) {
            f = b.getElementsByClassName(e);
            g = 0;
            for(h = f.length;g < h;g++) {
              b = f[g], b.className == e && a.match(b) && c.push(b)
            }
          }else {
            if(a.notOnlyElement) {
              (function(b) {
                for(var f = arguments.callee, g = b.firstChild;g;g = g.nextSibling) {
                  o.attrMatch(g, d, e) && a.match(g.nodeType) && c.push(g), f(g)
                }
              })(b)
            }else {
              if(f = a.name, b.getElementsByTagName && (f = b.getElementsByTagName(f))) {
                for(g = 0;b = f[g++];) {
                  o.attrMatch(b, d, e) && c.push(b)
                }
              }
            }
          }
      ...
      return c
    }, getChildNodes:function(a, b, c, d, e) {
      for(b = b.firstChild;b;b = b.nextSibling) {
        o.attrMatch(b, d, e) && a.match(b) && c.push(b)
      }
      return c
    }};
    ...
    r = function(a, b) {
      this.axis = a;
      this.reverse = r.axises[a][0];
      this.func = r.axises[a][1];
      this.test = b;
      this.predicates = [];
      this._quickAttr = r.axises[a][2]
    };
    r.axises = {ancestor:[!0, function(a, b, c, d, e, f, g) {
      for(;b = b.parentNode;) {
        f && b.nodeType == 1 && f.reserveDelByNode(b, g, !0), a.match(b) && c.unshift(b)
      }
      return c
    }], "ancestor-or-self":[!0, function(a, b, c, d, e, f, g) {
      do {
        f && b.nodeType == 1 && f.reserveDelByNode(b, g, !0), a.match(b) && c.unshift(b)
      }while(b = b.parentNode);
      return c
    }], attribute:[!1, function(a, b, c) {
      if(b = b.attributes) {
        if(a.notOnlyElement && a.type == 0 || a.name == "*") {
          for(var a = 0, d;d = b[a];a++) {
            c.push(d)
          }
        }else {
          (d = b.getNamedItem(a.name)) && c.push(d)
        }
      }
      return c
    }], child:[!1, o.getChildNodes, !0], descendant:[!1, o.getDescendantNodes, !0], "descendant-or-self":[!1, function(a, b, c, d, e, f, g) {
      o.attrMatch(b, d, e) && a.match(b) && c.push(b);
      return o.getDescendantNodes(a, b, c, d, e, f, g)
    }, !0], following:[!1, function(a, b, c, d, e) {
      do {
        for(var f = b;f = f.nextSibling;) {
          o.attrMatch(f, d, e) && a.match(f) && c.push(f), c = o.getDescendantNodes(a, f, c, d, e)
        }
      }while(b = b.parentNode);
      return c
    }, !0], "following-sibling":[!1, function(a, b, c, d, e, f, g) {
      for(;b = b.nextSibling;) {
        f && b.nodeType == 1 && f.reserveDelByNode(b, g), a.match(b) && c.push(b)
      }
      return c
    }], namespace:[!1, function(a, b, c) {
      return c
    }], parent:[!1, function(a, b, c) {
      if(b.nodeType == 9) {
        return c
      }
      if(b.nodeType == 2) {
        return c.push(b.ownerElement), c
      }
      b = b.parentNode;
      a.match(b) && c.push(b);
      return c
    }], preceding:[!0, function(a, b, c, d, e) {
      var f = [];
      do {
        f.unshift(b)
      }while(b = b.parentNode);
      for(var g = 1, h = f.length;g < h;g++) {
        ...
        for(var j = 0, l = i.length;j < l;j++) {
          b = i[j], o.attrMatch(b, d, e) && a.match(b) && c.push(b), c = o.getDescendantNodes(a, b, c, d, e)
        }
      }
      return c
    }, !0], "preceding-sibling":[!0, function(a, b, c, d, e, f, g) {
      for(;b = b.previousSibling;) {
        f && b.nodeType == 1 && f.reserveDelByNode(b, g, !0), a.match(b) && c.unshift(b)
      }
      return c
    }], self:[!1, function(a, b, c) {
      a.match(b) && c.push(b);
      return c
    }]};
    r.parse = function(a) {
      ...
      if(a.peek() == ".") {
        ...
        if(a.peek() == "..") {
          b = this.parent(), a.next()
        }else {
          if(a.peek() == "@") {
            if(b = "attribute", a.next(), a.empty()) {
              throw Error("missing attribute name");
            }
          }else {
            if(a.peek(1) == "::") {
              if(!/(?![0-9])[\w]/.test(a.peek().charAt(0))) {
                throw Error("bad token: " + a.next());
              }
              b = a.next();
              a.next();
              if(!this.axises[b]) {
                throw Error("invalid axis: " + b);
              }
              if(a.empty()) {
          ...
          if(/(?![0-9])[\w]/.test(c.charAt(0))) {
            if(a.peek(1) == "(") {
              if(!p.types[c]) {
                throw Error("invalid node type: " + c);
              }
              c = p.parse(a)
            }else {
              c = l.parse(a)
    ...
    r.self = function() {
      return new r("self", new p("node"))
    };
    r.parent = function() {
      return new r("parent", new p("node"))
    };
    r.prototype = new y;
    r.prototype.evaluate = function(a, b, c, d) {
      var e = a.node;
      if(!b && this.op == "//") {
        if(!this.needContextPosition && this.axis == "child") {
          this.quickAttr ? (a = this.attrValueExpr ? this.attrValueExpr.string(a) : null, d = o.getDescendantNodes(this.test, e, new m, this.attrName, a, c, d), d = this.evaluatePredicates(d, 1)) : (d = o.getDescendantNodes(this.test, e, new m, null, null, c, d), d = this.evaluatePredicates(d))
        }else {
          e = new r("descendant-or-self", new p("node"));
          c = e.evaluate(a, !1, c, d).list();
          d = null;
          e.op = "/";
          a = 0;
          for(e = c.length;a < e;a++) {
            d ? d.merge(this.evaluate(new v(c[a]), !0)) : d = this.evaluate(new v(c[a]), !0)
          }
          d = d || new m
        }
      }else {
        this.needContextPosition && (d = c = null), this.quickAttr ? (a = this.attrValueExpr ? this.attrValueExpr.string(a) : null, d = this.func(this.test, e, new m, this.attrName, a, c, d), d = this.evaluatePredicates(d, 1)) : (d = this.func(this.test, e, new m, null, null, c, d), d = this.evaluatePredicates(d)), c && c.doDel()
      }
      return d
    };
    r.prototype.predicate = function(a) {
      this.predicates.push(a);
      if(a.needContextPosition || a.datatype == "number" || a.datatype == "void") {
        this.needContextPosition = !0
      }
      if(this._quickAttr && this.predicates.length == 1 && a.quickAttr) {
        this.attrName = a.attrName, this.attrValueExpr = a.attrValueExpr, this.quickAttr = !0
      }
    };
    ...
    p.types = {comment:1, text:1, "processing-instruction":1, node:1};
    p.parse = function(a) {
      var b, c, d;
      b = a.next();
      a.next();
    ...
    p.prototype = new a;
    p.prototype.notOnlyElement = !0;
    p.prototype.match = function(a) {
      return!this.type || this.type == a.nodeType
    };
    p.prototype.show = function(a) {
      var a = a || "", b = "";
      b += a + "nodetype: " + this.type + "\n";
      this.literal && (a += "    ", b += this.literal.show(a));
      return b
    };
    ...
    l.parse = function(a) {
      return a.peek() != "*" && a.peek(1) == ":" && a.peek(2) == "*" ? new l(a.next() + a.next() + a.next()) : new l(a.next())
    };
    l.prototype = new a;
    l.prototype.match = function(a) {
      var b = a.nodeType;
      if(b == 1 || b == 2) {
        if(this.name == "*" || this.name == a.nodeName.toLowerCase()) {
          return!0
        }
      }
      return!1
    ...
    w.prototype = new a;
    w.prototype.datatype = "void";
    w.prototype.show = function(a) {
      var b = "";
      b += (a || "") + "variable: " + this.name + "\n";
      return b
    };
    ...
    n = function(a) {
      this.text = a.substring(1, a.length - 1)
    };
    n.parse = function(a) {
      a = a.next();
      if(a.length < 2) {
    ...
    n.prototype = new a;
    n.prototype.datatype = "string";
    n.prototype.evaluate = function() {
      return this.text
    };
    n.prototype.show = function(a) {
      var b = "";
      b += (a || "") + "literal: " + this.text + "\n";
      return b
    };
    ...
    j = function(a) {
      ...
      this.needContextNodeInfo = b[3];
      this.needContextNode = this.needContextNodeInfo[0]
    };
    j.funcs = {"context-node":[function() {
      ...
      a = new m;
      b = this.node;
      b.nodeType == 9 ? a.push(b) : a.push(b.ownerDocument);
      return a
    }, "nodeset", !1, []], last:[function() {
      if(arguments.length != 0) {
    ...
    }, "number", !0, []], count:[function(a) {
      if(arguments.length != 1 || !(a = a.evaluate(this)).isNodeSet) {
        throw Error("Function count expects (nodeset)");
      }
      return a.length
    }, "number", !1, []], id:[function(a) {
      var b, c, d, f, g, h;
      if(arguments.length != 1) {
        throw Error("Function id expects (object)");
      }
      b = this.node;
      h = b.nodeType == 9 ? b : b.ownerDocument;
      a = a.string(this);
      b = a.split(/\s+/);
      c = new m;
      for(d = 0, e = b.length;d < e;d++) {
        if(f = b[d], g = h.getElementById(f), z.opera && g && g.id != f) {
          for(var i = h.getElementsByName(f), j = 0, l = i.length;j < l;j++) {
            g = i[j], g.id == f && c.push(g)
          }
        }else {
          g && c.push(g)
        }
      ...
      c.isSorted = !1;
      return c
    }, "nodeset", !1, []], "local-name":[function(a) {
      var b;
      switch(arguments.length) {
        case 0:
          ...
          break;
        case 1:
          if((a = a.evaluate(this)).isNodeSet) {
            b = a.first();
            break
          }
        ;
    ...
    }, "string", !1, [!0, !1]], name:[function(a) {
      return j.funcs["local-name"][0].apply(this, arguments)
    }, "string", !1, [!0, !1]], "namespace-uri":[function() {
      return""
    }, "string", !1, [!0, !1]], string:[function(a) {
      switch(arguments.length) {
        case 0:
          a = o.to("string", this.node);
          break;
        case 1:
          a = a.string(this);
          break;
      ...
      return a
    }, "string", !1, [!0, !1]], concat:[function(a, b) {
      if(arguments.length < 2) {
        throw Error("Function concat expects (string, string[, ...])");
      }
      for(var c = "", d = 0, e = arguments.length;d < e;d++) {
        c += arguments[d].string(this)
      }
      return c
    }, "string", !1, []], "starts-with":[function(a, b) {
      if(arguments.length != 2) {
    ...
    }, "boolean", !1, []], contains:[function(a, b) {
      if(arguments.length != 2) {
      ...
      b = b.string(this);
      return a.indexOf(b) != -1
    }, "boolean", !1, []], substring:[function(a, b, c) {
      var d, e, a = a.string(this), b = b.number(this);
      switch(arguments.length) {
        case 2:
          c = a.length - b + 1;
          break;
      ...
      d = b - 1;
      e = b + c - 1;
      return e == Infinity ? a.substring(d < 0 ? 0 : d) : a.substring(d < 0 ? 0 : d, e)
    }, "string", !1, []], "substring-before":[function(a, b) {
      var c;
      if(arguments.length != 2) {
      ...
      b = b.string(this);
      c = a.indexOf(b);
      return c == -1 ? "" : a.substring(0, c)
    }, "string", !1, []], "substring-after":[function(a, b) {
      if(arguments.length != 2) {
        throw Error("Function substring-after expects (string, string)");
      }
      var a = a.string(this), b = b.string(this), c = a.indexOf(b);
      return c == -1 ? "" : a.substring(c + b.length)
    }, "string", !1, []], "string-length":[function(a) {
      switch(arguments.length) {
        case 0:
          a = o.to("string", this.node);
          break;
      ...
      return a.length
    }, "number", !1, [!0, !1]], "normalize-space":[function(a) {
      switch(arguments.length) {
        case 0:
          a = o.to("string", this.node);
          break;
    ...
    }, "string", !1, [!0, !1]], translate:[function(a, b, c) {
      if(arguments.length != 3) {
        throw Error("Function translate expects (string, string, string)");
      }
      for(var a = a.string(this), b = b.string(this), c = c.string(this), d = [], e = 0, f = b.length;e < f;e++) {
        var g = b.charAt(e);
        d[g] || (d[g] = c.charAt(e) || "")
      }
      for(var h = "", e = 0, f = a.length;e < f;e++) {
        var g = a.charAt(e), i = d[g];
        h += i != void 0 ? i : g
      }
      return h
    }, "string", !1, []], "boolean":[function(a) {
      if(arguments.length != 1) {
        throw Error("Function boolean expects (object)");
      }
      return a.bool(this)
    }, "boolean", !1, []], not:[function(a) {
      if(arguments.length != 1) {
      ...
      return!1
    }, "boolean", !1, []], lang:[function() {
      return!1
    }, "boolean", !1, []], number:[function(a) {
      switch(arguments.length) {
        case 0:
          a = o.to("number", this.node);
          break;
        case 1:
          a = a.number(this);
          break;
    ...
    j.prototype.evaluate = function(a) {
      return this.func.apply(a, this.args)
    };
    j.prototype.arg = function(a) {
      this.args.push(a);
      if(a.needContextPosition) {
        this.needContextPosition = !0
      }
      ...
      this.needContextNode = b.needContextNode || this.needContextNodeInfo[b.length]
    };
    j.prototype.show = function(a) {
      var a = a || "", b = "";
      b += a + "function: " + this.name + "\n";
      a += "    ";
      if(this.args.length) {
        b += a + "arguments: \n";
        a += "    ";
        for(var c = 0;c < this.args.length;c++) {
          b += this.args[c].show(a)
        }
      }
      return b
    };
    var A = {uuid:1, get:function(a) {
      return a.__jsxpath_id__ || (a.__jsxpath_id__ = this.uuid++)
    }};
    ...
    m.prototype.isNodeSet = !0;
    m.prototype.isSorted = !0;
    m.prototype.merge = function(a) {
      this.isSorted = !1;
      if(a.only) {
        return this.push(a.only)
      }
      if(this.only) {
        var b = this.only;
        delete this.only;
      ...
      for(var a = a.nodes, b = 0, c = a.length;b < c;b++) {
        this._add(a[b])
      }
    };
    m.prototype.sort = function() {
      if(!this.only && !this.sortOff && !this.isSorted) {
        this.isSorted = !0, this.idIndexMap = null, this.nodes.sort(function(a, b) {
          if(a == b) {
            return 0
          }
          if(a.compareDocumentPosition) {
            ...
            for(var c = a, d = b, e = a, f = b, g = 0, h = 0;e = e.parentNode;) {
              g++
            }
            for(;f = f.parentNode;) {
              h++
            ...
            for(;(e = c.parentNode) != (f = d.parentNode);) {
              c = e, d = f
            }
            for(;c = c.nextSibling;) {
              if(c == d) {
    ...
    m.prototype.reserveDelByNodeID = function(a, b, c) {
      if(a = this.createIdIndexMap()[a]) {
        (c && this.length - b - 1 > a || !c && b < a) && this.reserveDels.push({value:a, order:String.fromCharCode(a), toString:function() {
          return this.order
        }, valueOf:function() {
          return this.value
        }})
    ...
    m.prototype.reserveDelByNode = function(a, b, c) {
      this.reserveDelByNodeID(A.get(a), b, c)
    };
    m.prototype.doDel = function() {
      if(this.reserveDels.length) {
        for(var a = this.length < 65536 ? this.reserveDels.sort(function(a, b) {
          return b - a
        }) : this.reserveDels.sort(function(a, b) {
          return b - a
    ...
    m.prototype.createIdIndexMap = function() {
      if(this.idIndexMap) {
        return this.idIndexMap
      }else {
        for(var a = this.idIndexMap = {}, b = this.nodes, c = 0, d = b.length;c < d;c++) {
          var e = A.get(b[c]);
          a[e] = c
        }
        return a
    ...
    m.prototype.del = function(a) {
      this.length--;
      this.only ? delete this.only : (a = this.nodes.splice(a, 1)[0], this._first == a && (delete this._first, delete this._firstSourceIndex, delete this._firstSubIndex), delete this.seen[A.get(a)])
    };
    m.prototype.delDescendant = function(a, b) {
      if(!this.only) {
        var c = a.nodeType;
        if(!(c != 1 && c != 9) && !z.applewebkit2) {
          if(!a.contains) {
            if(c == 1) {
              var d = a, a = {contains:function(a) {
                return a.compareDocumentPosition(d) & 8
              }}
            }else {
              a = {contains:function() {
                return!0
          ...
          for(var c = this.nodes, e = b + 1;e < c.length;e++) {
            a.contains(c[e]) && (this.del(e), e--)
          }
        }
      }
    };
    m.prototype._add = function(a, b) {
      var c = this.seen, d = A.get(a);
      if(c[d]) {
        return!0
      }
      c[d] = !0;
      this.length++;
      b ? this.nodes.unshift(a) : this.nodes.push(a)
    };
    m.prototype.unshift = function(a) {
      if(this.length) {
        ...
        return this._add(a, !0)
      }else {
        this.length++, this.only = a
      }
    };
    ...
    m.prototype.string = function() {
      var a = this.only || this.first();
      return a ? o.to("string", a) : ""
    };
    ...
    m.prototype.iterator = function(a) {
      this.sort();
      var b = this;
      if(a) {
        return c = 0, function() {
          var a = b.length - c++ - 1;
          return b.only && a == 0 ? b.only : b.nodes[a]
        }
      }else {
        var c = 0;
        return function() {
          return b.only && c++ == 0 ? b.only : b.nodes[c++]
        }
      }
    };
    var a = function(a) {
      var a = a || this, b = a.document;
      a.XPathExpression = function(b) {
        if(!b.length) {
          throw a.Error("no expression");
        }
        b = this.lexer = x(b);
        if(b.empty()) {
          throw a.Error("no expression");
        ...
        this.expr = i.parse(b);
        if(!b.empty()) {
          throw a.Error("bad token: " + b.next());
        }
      };
      ...
      a.XPathResult = function(a, b) {
        ...
        switch(b) {
          case 1:
            this.numberValue = a.isNodeSet ? a.number() : +a;
            break;
          case 2:
            this.stringValue = a.isNodeSet ? a.string() : "" + a;
            break;
          case 3:
            this.booleanValue = a.isNodeSet ? a.bool() : !!a;
            break;
          case 4:
          ;
          case 5:
      ...
      a.XPathResult.prototype.snapshotItem = function(a) {
        return this.nodes[a]
      };
      a.XPathResult.ANY_TYPE = 0;
      a.XPathResult.NUMBER_TYPE = 1;
      a.XPathResult.STRING_TYPE = 2;
      a.XPathResult.BOOLEAN_TYPE = 3;
      a.XPathResult.UNORDERED_NODE_ITERATOR_TYPE = 4;
      a.XPathResult.ORDERED_NODE_ITERATOR_TYPE = 5;
      a.XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE = 6;
      a.XPathResult.ORDERED_NODE_SNAPSHOT_TYPE = 7;
      a.XPathResult.ANY_UNORDERED_NODE_TYPE = 8;
      a.XPathResult.FIRST_ORDERED_NODE_TYPE = 9;
      b.createExpression = function(b) {
        return new a.XPathExpression(b, null)
      };
      b.evaluate = function(a, c, d, e) {
        return b.createExpression(a, null).evaluate(c, e)
      }
    }, B;
    if(b.targetFrame && (h = document.getElementById(b.targetFrame))) {
      B = h.contentWindow
    }
    if(b.exportInstaller) {
      window.install = a
    }
    if(!b.hasNative || !b.useNative) {
      a(B || window)
    }
  }
})();
    ...
    var b = function(b, c, d) {
      return function n(a, b) {
        return new cljs.core.LazySeq(null, !1, function() {
          ...
          return cljs.core.truth_(c) ? cljs.core.cons.call(null, cljs.core.first.call(null, c), n.call(null, cljs.core.rest.call(null, c), b)) : cljs.core.truth_(b) ? n.call(null, cljs.core.first.call(null, b), cljs.core.next.call(null, b)) : null
        })
...
cljs.core.apply = function() {
  var a = null, b = function() {
    var a = function(a, b, c, d, i, k) {
      ...
      var j = null;
      goog.isDef(k) && (j = cljs.core.array_seq(Array.prototype.slice.call(arguments, 5), 0));
      return a.call(this, b, d, g, h, i, j)
    };
    ...
    switch(arguments.length) {
      case 2:
        var i = a, k = d, j = i.cljs$lang$maxFixedArity;
        return cljs.core.truth_(i.cljs$lang$applyTo) ? cljs.core.truth_(cljs.core.bounded_count.call(null, k, j + 1) <= j) ? i.apply(i, cljs.core.to_array.call(null, k)) : i.cljs$lang$applyTo(k) : i.apply(i, cljs.core.to_array.call(null, k));
      case 3:
        return i = a, k = cljs.core.list_STAR_.call(null, d, e), j = i.cljs$lang$maxFixedArity, cljs.core.truth_(i.cljs$lang$applyTo) ? cljs.core.truth_(cljs.core.bounded_count.call(null, k, j) <= j) ? i.apply(i, cljs.core.to_array.call(null, k)) : i.cljs$lang$applyTo(k) : i.apply(i, cljs.core.to_array.call(null, k));
      case 4:
        return i = a, k = cljs.core.list_STAR_.call(null, d, e, f), j = i.cljs$lang$maxFixedArity, cljs.core.truth_(i.cljs$lang$applyTo) ? cljs.core.truth_(cljs.core.bounded_count.call(null, k, j) <= j) ? i.apply(i, cljs.core.to_array.call(null, k)) : i.cljs$lang$applyTo(k) : i.apply(i, cljs.core.to_array.call(null, k));
      case 5:
        return i = a, k = cljs.core.list_STAR_.call(null, d, e, f, g), j = i.cljs$lang$maxFixedArity, cljs.core.truth_(i.cljs$lang$applyTo) ? cljs.core.truth_(cljs.core.bounded_count.call(null, k, j) <= j) ? i.apply(i, cljs.core.to_array.call(null, k)) : i.cljs$lang$applyTo(k) : i.apply(i, cljs.core.to_array.call(null, k));
      default:
        return b.apply(this, arguments)
    }
    throw"Invalid arity: " + arguments.length;
  ...
  var a = null, b = function(a, b) {
    return function() {
      var c = null, d = function() {
        ...
        switch(arguments.length) {
          ...
          case 3:
            return a.call(null, b.call(null, c, g, j));
          default:
    ...
    return function() {
      var d = null, i = function() {
        var d = function(d, h, i, m) {
          var k = null;
          goog.isDef(m) && (k = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3), 0));
          return a.call(null, b.call(null, cljs.core.apply.call(null, c, d, h, i, k)))
        };
        d.cljs$lang$maxFixedArity = 3;
        d.cljs$lang$applyTo = function(d) {
          var h = cljs.core.first(d), i = cljs.core.first(cljs.core.next(d)), m = cljs.core.first(cljs.core.next(cljs.core.next(d))), d = cljs.core.rest(cljs.core.next(cljs.core.next(d)));
          return a.call(null, b.call(null, cljs.core.apply.call(null, c, h, i, m, d)))
        };
        return d
      }(), d = function(d, h, n, l) {
        switch(arguments.length) {
          ...
          case 3:
            return a.call(null, b.call(null, c.call(null, d, h, n)));
          default:
    ...
    var a = function(a, b, c, d) {
      ...
      var j = null;
      goog.isDef(f) && (j = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3), 0));
      return a.call(this, b, c, d, j)
    };
  ...
  var a = null, b = function(a, b) {
    return function() {
      var c = null, d = function() {
        ...
        switch(arguments.length) {
          ...
          case 3:
            return a.call(null, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, c)) ? b : c, g, j);
          default:
            return d.apply(this, arguments)
        }
        throw"Invalid arity: " + arguments.length;
    ...
    return function() {
      var d = null, i = function() {
        ...
        switch(arguments.length) {
          ...
          case 3:
            return a.call(null, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, d)) ? b : d, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, h)) ? c : h, n);
          default:
            return i.apply(this, arguments)
        }
        throw"Invalid arity: " + arguments.length;
    ...
    return function() {
      var i = null, k = function() {
        var i = function(i, m, j, k) {
          return cljs.core.apply.call(null, a, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, i)) ? b : i, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, m)) ? c : m, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, j)) ? d : j, k)
        }, k = function(a, b, c, d) {
          var e = null;
        ...
        switch(arguments.length) {
          case 2:
            return a.call(null, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, i)) ? b : i, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, n)) ? c : n);
          case 3:
            return a.call(null, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, i)) ? b : i, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, n)) ? c : n, cljs.core.truth_(cljs.core.nil_QMARK_.call(null, l)) ? d : l);
          default:
      ...
      var b = null, c = function() {
        ...
        switch(arguments.length) {
          ...
          case 1:
            return a.call(null, b);
          case 2:
            var l = d, m = a.call(null, b);
            return cljs.core.truth_(m) ? m : a.call(null, l);
          case 3:
            var m = d, l = e, p = a.call(null, b);
            cljs.core.truth_(p) ? l = p : (m = a.call(null, m), l = cljs.core.truth_(m) ? m : a.call(null, l));
            return l;
          default:
            return c.apply(this, arguments)
        }
      ...
      var c = null, d = function(c, d, e) {
        ...
        switch(arguments.length) {
          case 0:
            return null;
          case 1:
            var p = c, o = a.call(null, p);
            return cljs.core.truth_(o) ? o : b.call(null, p);
          case 2:
            var o = c, p = h, q = a.call(null, o);
            cljs.core.truth_(q) ? p = q : (q = a.call(null, p), cljs.core.truth_(q) ? p = q : (o = b.call(null, o), p = cljs.core.truth_(o) ? o : b.call(null, p)));
            return p;
          case 3:
      ...
      var d = null, e = function(d, e) {
        ...
        switch(arguments.length) {
          ...
          case 1:
            ...
            q = d;
            var s = a.call(null, q);
            cljs.core.truth_(s) ? q = s : (s = b.call(null, q), q = cljs.core.truth_(s) ? s : c.call(null, q));
            return q;
          case 2:
            return e.call(this, d, i);
          case 3:
            return j.call(this, d, i, p);
          default:
            return n.apply(this, arguments)
        }
        throw"Invalid arity: " + arguments.length;
...
cljs.core.map = function() {
  var a = null, b = function(b, c) {
    ...
    return new cljs.core.LazySeq(null, !1, function() {
      var k = cljs.core.seq.call(null, c), j = cljs.core.seq.call(null, d), n = cljs.core.seq.call(null, e);
      return cljs.core.truth_(cljs.core.truth_(k) ? cljs.core.truth_(j) ? n : j : k) ? cljs.core.cons.call(null, b.call(null, cljs.core.first.call(null, k), cljs.core.first.call(null, j), cljs.core.first.call(null, n)), a.call(null, b, cljs.core.rest.call(null, k), cljs.core.rest.call(null, j), cljs.core.rest.call(null, n))) : null
    })
  }, e = function() {
    var b = function(b, c, d, e, f) {
      return a.call(null, function(a) {
        ...
        return new cljs.core.LazySeq(null, !1, function() {
          ...
          return cljs.core.truth_(cljs.core.every_QMARK_.call(null, cljs.core.identity, c)) ? cljs.core.cons.call(null, a.call(null, cljs.core.first, c), m.call(null, a.call(null, cljs.core.rest, c))) : null
        })
          ...
          return new cljs.core.LazySeq(null, !1, function() {
            for(;;) {
              if(cljs.core.truth_(cljs.core.seq.call(null, b))) {
                ...
                return cljs.core.cons.call(null, cljs.core.Vector.fromArray([f.call(null, c), h.call(null, a[c])]), j.call(null, cljs.core.rest.call(null, b)))
              }else {
                return null
              }
            }
...
domina.by_class = function by_class(b) {
  if(cljs.core.truth_(cljs.core.undefined_QMARK_.call(null, domina.t3109))) {
    domina.t3109 = function(b, d) {
      this.class_name = b;
      this.by_class = d
    }, domina.t3109.prototype.domina$DomContent$ = !0, domina.t3109.prototype.domina$DomContent$nodes = function() {
      return goog.dom.getElementsByClass.call(null, cljs.core.name.call(null, this.class_name))
    }, domina.t3109.prototype.domina$DomContent$single_node = function() {
      return goog.dom.getElementByClass.call(null, cljs.core.name.call(null, this.class_name))
    }
  }
  return new domina.t3109(b, by_class)
};
...
domina.xpath.xpath = function() {
  var a = null, b = function(b, d) {
    if(cljs.core.truth_(cljs.core.undefined_QMARK_.call(null, domina.xpath.t3097))) {
      domina.xpath.t3097 = function(a, b, c) {
        this.expr = a;
        this.base = b;
        this.xpath = c
      }, domina.xpath.t3097.prototype.domina$DomContent$ = !0, domina.xpath.t3097.prototype.domina$DomContent$nodes = function() {
      ...
      }, domina.xpath.t3097.prototype.domina$DomContent$single_node = function() {
    ...
    return new domina.xpath.t3097(d, b, a)
  };
  return a = function(c, d) {
    switch(arguments.length) {
      case 1:
...
domina.test.add_test.call(null, "prepend a single child to a single parent", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "1", domina.text.call(null, domina.xpath.xpath.call(null, "//body/div[1]"))))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "1", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//body/div[1]"), cljs.core.hash_map("\ufdd0'line", 138))), cljs.core.hash_map("\ufdd0'line", 138))), cljs.core.hash_map("\ufdd0'line", 138)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "2", domina.text.call(null, domina.xpath.xpath.call(null, "//body/div[2]"))))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "2", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//body/div[2]"), cljs.core.hash_map("\ufdd0'line", 139))), cljs.core.hash_map("\ufdd0'line", 139))), cljs.core.hash_map("\ufdd0'line", 139)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "3", domina.text.call(null, domina.xpath.xpath.call(null, "//body/div[3]"))))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "3", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//body/div[3]"), cljs.core.hash_map("\ufdd0'line", 140))), cljs.core.hash_map("\ufdd0'line", 140))), cljs.core.hash_map("\ufdd0'line", 140)))));
  }
});
...
domina.test.add_test.call(null, "can retrieve a css property value", function() {
  ...
  if(cljs.core.truth_(cljs.core.nil_QMARK_.call(null, domina.style.call(null, domina.xpath.xpath.call(null, "//div"), "\ufdd0'no-such-style")))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'nil?", cljs.core.with_meta(cljs.core.list("\ufdd1'style", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 294)), "\ufdd0'no-such-style"), cljs.core.hash_map("\ufdd0'line", 294))), cljs.core.hash_map("\ufdd0'line", 294)))));
  }
});
domina.test.add_test.call(null, "can retrieve an HTML attribute value", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div"), "height")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 299)), "height"), cljs.core.hash_map("\ufdd0'line", 299))), cljs.core.hash_map("\ufdd0'line", 299)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div"), "\ufdd0'height")))) {
  ...
  if(cljs.core.truth_(cljs.core.nil_QMARK_.call(null, domina.attr.call(null, domina.xpath.xpath.call(null, "//div"), "\ufdd0'no-such-attr:c")))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'nil?", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 301)), "\ufdd0'no-such-attr:c"), cljs.core.hash_map("\ufdd0'line", 301))), cljs.core.hash_map("\ufdd0'line", 301)))));
  }
});
...
domina.test.add_test.call(null, "can set a css property on multiple nodes", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "red", domina.style.call(null, domina.xpath.xpath.call(null, "//div[1]"), "color")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "red", cljs.core.with_meta(cljs.core.list("\ufdd1'style", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 315)), "color"), cljs.core.hash_map("\ufdd0'line", 315))), cljs.core.hash_map("\ufdd0'line", 315)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "red", domina.style.call(null, domina.xpath.xpath.call(null, "//div[2]"), "color")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "red", cljs.core.with_meta(cljs.core.list("\ufdd1'style", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 316)), "color"), cljs.core.hash_map("\ufdd0'line", 316))), cljs.core.hash_map("\ufdd0'line", 316)))));
  }
});
domina.test.add_test.call(null, "can set a html attribute on a single node", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[1]"), "width")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 323)), "width"), cljs.core.hash_map("\ufdd0'line", 323))), cljs.core.hash_map("\ufdd0'line", 323)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[2]"), "width")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 324)), "width"), cljs.core.hash_map("\ufdd0'line", 324))), cljs.core.hash_map("\ufdd0'line", 324)))));
  }
});
domina.test.add_test.call(null, "can set a html attribute on a single node", function() {
  domina.test.reset.call(null);
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[1]"), "width")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 330)), "width"), cljs.core.hash_map("\ufdd0'line", 330))), cljs.core.hash_map("\ufdd0'line", 330)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[2]"), "width")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 331)), "width"), cljs.core.hash_map("\ufdd0'line", 331))), cljs.core.hash_map("\ufdd0'line", 331)))));
  }
});
...
domina.test.add_test.call(null, "can set multiple CSS styles on a single node", function() {
  ...
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "red", domina.style.call(null, domina.xpath.xpath.call(null, "//div"), "color")))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "red", cljs.core.with_meta(cljs.core.list("\ufdd1'style", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 355)), "color"), cljs.core.hash_map("\ufdd0'line", 355))), cljs.core.hash_map("\ufdd0'line", 355)))));
  }
});
domina.test.add_test.call(null, "can set multiple CSS styles on multiple nodes", function() {
  ...
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "red", domina.style.call(null, domina.xpath.xpath.call(null, "//div[2]"), "color")))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "red", cljs.core.with_meta(cljs.core.list("\ufdd1'style", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 365)), "color"), cljs.core.hash_map("\ufdd0'line", 365))), cljs.core.hash_map("\ufdd0'line", 365)))));
  }
});
domina.test.add_test.call(null, "can set multiple HTML attributes on a single node", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div"), "width")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 372)), "width"), cljs.core.hash_map("\ufdd0'line", 372))), cljs.core.hash_map("\ufdd0'line", 372)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "24", domina.attr.call(null, domina.xpath.xpath.call(null, "//div"), "height")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "24", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 373)), "height"), cljs.core.hash_map("\ufdd0'line", 373))), cljs.core.hash_map("\ufdd0'line", 373)))));
  }
});
domina.test.add_test.call(null, "can set multiple CSS styles on multiple nodes", function() {
  domina.test.reset.call(null);
  ...
  domina.set_attrs_BANG_.call(null, domina.xpath.xpath.call(null, "//div"), cljs.core.ObjMap.fromObject(["\ufdd0'width", "\ufdd0'height"], {"\ufdd0'width":42, "\ufdd0'height":24}));
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[1]"), "width")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 380)), "width"), cljs.core.hash_map("\ufdd0'line", 380))), cljs.core.hash_map("\ufdd0'line", 380)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "24", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[1]"), "height")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "24", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 381)), "height"), cljs.core.hash_map("\ufdd0'line", 381))), cljs.core.hash_map("\ufdd0'line", 381)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "42", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[2]"), "width")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "42", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 382)), "width"), cljs.core.hash_map("\ufdd0'line", 382))), cljs.core.hash_map("\ufdd0'line", 382)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "24", domina.attr.call(null, domina.xpath.xpath.call(null, "//div[2]"), "height")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "24", cljs.core.with_meta(cljs.core.list("\ufdd1'attr", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 383)), "height"), cljs.core.hash_map("\ufdd0'line", 383))), cljs.core.hash_map("\ufdd0'line", 383)))));
  }
});
domina.test.add_test.call(null, "test the has-class? function", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 389)), "class1"), cljs.core.hash_map("\ufdd0'line", 389))), cljs.core.hash_map("\ufdd0'line", 389)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class2")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 390)), "class2"), cljs.core.hash_map("\ufdd0'line", 390))), cljs.core.hash_map("\ufdd0'line", 390)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !1, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class2")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !1, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 391)), "class2"), cljs.core.hash_map("\ufdd0'line", 391))), cljs.core.hash_map("\ufdd0'line", 391)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, !1, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class1")))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !1, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 392)), "class1"), cljs.core.hash_map("\ufdd0'line", 392))), cljs.core.hash_map("\ufdd0'line", 392)))));
  }
});
domina.test.add_test.call(null, "can add a CSS class to a single node", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 399)), "class1"), cljs.core.hash_map("\ufdd0'line", 399))), cljs.core.hash_map("\ufdd0'line", 399)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div"), "class2")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 400)), "class2"), cljs.core.hash_map("\ufdd0'line", 400))), cljs.core.hash_map("\ufdd0'line", 400)))));
  }
});
domina.test.add_test.call(null, "can add a CSS class to multiple nodes", function() {
  ...
  domina.add_class_BANG_.call(null, domina.xpath.xpath.call(null, "//div"), "class2");
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 407)), "class1"), cljs.core.hash_map("\ufdd0'line", 407))), cljs.core.hash_map("\ufdd0'line", 407)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 408)), "class1"), cljs.core.hash_map("\ufdd0'line", 408))), cljs.core.hash_map("\ufdd0'line", 408)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class2")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 409)), "class2"), cljs.core.hash_map("\ufdd0'line", 409))), cljs.core.hash_map("\ufdd0'line", 409)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class2")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 410)), "class2"), cljs.core.hash_map("\ufdd0'line", 410))), cljs.core.hash_map("\ufdd0'line", 410)))));
  }
});
domina.test.add_test.call(null, "can remove a CSS class from a single node", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !1, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !1, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 416)), "class1"), cljs.core.hash_map("\ufdd0'line", 416))), cljs.core.hash_map("\ufdd0'line", 416)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div"), "class2")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div"), cljs.core.hash_map("\ufdd0'line", 417)), "class2"), cljs.core.hash_map("\ufdd0'line", 417))), cljs.core.hash_map("\ufdd0'line", 417)))));
  }
});
domina.test.add_test.call(null, "can remove a CSS class from a multiple nodes", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !1, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !1, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 423)), "class1"), cljs.core.hash_map("\ufdd0'line", 423))), cljs.core.hash_map("\ufdd0'line", 423)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[1]"), "class2")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[1]"), cljs.core.hash_map("\ufdd0'line", 424)), "class2"), cljs.core.hash_map("\ufdd0'line", 424))), cljs.core.hash_map("\ufdd0'line", 424)))));
  }
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, !1, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class1")))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !1, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 425)), "class1"), cljs.core.hash_map("\ufdd0'line", 425))), cljs.core.hash_map("\ufdd0'line", 425)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, !0, domina.has_class_QMARK_.call(null, domina.xpath.xpath.call(null, "//div[2]"), "class2")))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", !0, cljs.core.with_meta(cljs.core.list("\ufdd1'has-class?", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//div[2]"), cljs.core.hash_map("\ufdd0'line", 426)), "class2"), cljs.core.hash_map("\ufdd0'line", 426))), cljs.core.hash_map("\ufdd0'line", 426)))));
  }
});
...
domina.test.add_test.call(null, "can retrieve the text value of a node with normalization.", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "Some text.", domina.text.call(null, domina.xpath.xpath.call(null, "//p"))))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Some text.", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//p"), cljs.core.hash_map("\ufdd0'line", 436))), cljs.core.hash_map("\ufdd0'line", 436))), cljs.core.hash_map("\ufdd0'line", 436)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Some text.", domina.text.call(null, domina.xpath.xpath.call(null, "//p"), !0)))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Some text.", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//p"), cljs.core.hash_map("\ufdd0'line", 437)), !0), cljs.core.hash_map("\ufdd0'line", 437))), cljs.core.hash_map("\ufdd0'line", 437)))));
  }
});
domina.test.add_test.call(null, "can set text on a single node", function() {
  ...
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Hello world!", domina.text.call(null, domina.xpath.xpath.call(null, "//p"))))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Hello world!", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//p"), cljs.core.hash_map("\ufdd0'line", 450))), cljs.core.hash_map("\ufdd0'line", 450))), cljs.core.hash_map("\ufdd0'line", 450)))));
  }
});
domina.test.add_test.call(null, "can set text on a multiple nodes", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "Hello world!", domina.text.call(null, domina.xpath.xpath.call(null, "//p[1]"))))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Hello world!", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//p[1]"), cljs.core.hash_map("\ufdd0'line", 456))), cljs.core.hash_map("\ufdd0'line", 456))), cljs.core.hash_map("\ufdd0'line", 456)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Hello world!", domina.text.call(null, domina.xpath.xpath.call(null, "//p[2]"))))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Hello world!", cljs.core.with_meta(cljs.core.list("\ufdd1'text", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//p[2]"), cljs.core.hash_map("\ufdd0'line", 457))), cljs.core.hash_map("\ufdd0'line", 457))), cljs.core.hash_map("\ufdd0'line", 457)))));
  }
});
domina.test.add_test.call(null, "can get a form field value", function() {
  ...
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Test Value", domina.value.call(null, domina.xpath.xpath.call(null, "//input"))))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Test Value", cljs.core.with_meta(cljs.core.list("\ufdd1'value", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//input"), cljs.core.hash_map("\ufdd0'line", 462))), cljs.core.hash_map("\ufdd0'line", 462))), cljs.core.hash_map("\ufdd0'line", 462)))));
  }
});
domina.test.add_test.call(null, "can set a form field value", function() {
  ...
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Test Value", domina.value.call(null, domina.xpath.xpath.call(null, "//input"))))) {
    ...
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Test Value", cljs.core.with_meta(cljs.core.list("\ufdd1'value", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//input"), cljs.core.hash_map("\ufdd0'line", 468))), cljs.core.hash_map("\ufdd0'line", 468))), cljs.core.hash_map("\ufdd0'line", 468)))));
  }
});
domina.test.add_test.call(null, "can set multiple form field values", function() {
  ...
  if(!cljs.core.truth_(cljs.core._EQ_.call(null, "Test Value", domina.value.call(null, domina.xpath.xpath.call(null, "//input[1]"))))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Test Value", cljs.core.with_meta(cljs.core.list("\ufdd1'value", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//input[1]"), cljs.core.hash_map("\ufdd0'line", 474))), cljs.core.hash_map("\ufdd0'line", 474))), cljs.core.hash_map("\ufdd0'line", 474)))));
  }
  if(cljs.core.truth_(cljs.core._EQ_.call(null, "Test Value", domina.value.call(null, domina.xpath.xpath.call(null, "//input[2]"))))) {
    return null
  }else {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'=", "Test Value", cljs.core.with_meta(cljs.core.list("\ufdd1'value", cljs.core.with_meta(cljs.core.list("\ufdd1'xpath", "//input[2]"), cljs.core.hash_map("\ufdd0'line", 475))), cljs.core.hash_map("\ufdd0'line", 475))), cljs.core.hash_map("\ufdd0'line", 475)))));
  }
});
